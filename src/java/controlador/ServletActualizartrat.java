 ...
 * @author HP
 */
@WebServlet(name = "ServletActualizartrat", urlPatterns = {"/ServletActualizartrat"})
public class ServletActualizartrat extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ds=request.getParameter("ds");
         ...
         boolean dat;
                tratamientogetset gs=new tratamientogetset(ds, d, c, r, v);
                  tratamiento usu=new tratamiento();
        ...
        d=request.getParameter("documento");
         ...
         boolean dat;
                            tratamientogetset gs=new tratamientogetset(d);
         tratamiento usu=new tratamiento();
         dat=usu.eliminar(gs);
