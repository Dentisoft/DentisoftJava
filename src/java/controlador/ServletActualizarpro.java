 ...
 * @author HP
 */
@WebServlet(name = "ServletActualizarpro", urlPatterns = {"/ServletActualizarpro"})
public class ServletActualizarpro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ds=request.getParameter("ds");
         ...
         boolean dat;
                procedimientogetset gs=new procedimientogetset(ds, d, c, r, v);
                procedimiento usu=new procedimiento();
        ...
        d=request.getParameter("documento");
         ...
         boolean dat;
         procedimientogetset gs=new procedimientogetset(d);
                            procedimiento usu=new procedimiento();
         dat=usu.eliminar(gs);
